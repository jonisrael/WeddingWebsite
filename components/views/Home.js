...
export default (st) => html`
  <section id="home-page">
    ...
    <div id="desktop-div">
      ...
      <div id="more-home-columns">
        <div class="columns"><img id="home-photo-2" /></div>
        <div class="columns"><img id="home-photo-3" /></div>
      </div>
    </div>
    ...
    <div id="mobile-div">
      <div id="story-rows">
        ...
        <div class="rows"><img id="home-photo-2" /></div>
        <div class="rows"><img id="home-photo-3" /></div>
      </div>
    </div>
  </section>
`;
